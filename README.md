...
El objetivo de este proyecto es realizar un análisis de datos relacionados con los servicios de Internet en el contexto de las telecomunicaciones. Exploraremos y analizaremos diferentes conjuntos de datos para obtener información e insights relevantes que puedan mejorar la calidad y el rendimiento de los servicios de Internet en Argentina.
